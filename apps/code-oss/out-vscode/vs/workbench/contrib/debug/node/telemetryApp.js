...
((Event5) => {
  ...
  function onceIf(event, condition) {
    return Event5.once(Event5.filter(event, condition));
  }
  Event5.onceIf = onceIf;
  ...
  Event5.forEach = forEach;
  function filter(event, filter2, disposable) {
    return snapshot((listener, thisArgs = null, disposables) => event((e) => filter2(e) && listener.call(thisArgs, e), null, disposables), disposable);
  }
  Event5.filter = filter;
  function signal(event) {
    return event;
  }
  Event5.signal = signal;
  function any(...events) {
    return (listener, thisArgs = null, disposables) => {
  ...
  function split(event, isT, disposable) {
    return [
      Event5.filter(event, isT, disposable),
      Event5.filter(event, (e) => !isT(e), disposable)
    ];
  }
  Event5.split = split;
  ...
  Event5.fromNodeEventEmitter = fromNodeEventEmitter;
  ...
  Event5.fromDOMEventEmitter = fromDOMEventEmitter;
  ...
  Event5.toPromise = toPromise;
  function forward(from, to) {
    return from((e) => to.fire(e));
  }
  Event5.forward = forward;
  function runAndSubscribe(event, handler, initial) {
    handler(initial);
    return event((e) => handler(e));
  }
  Event5.runAndSubscribe = runAndSubscribe;
  ...
  Event5.fromObservable = fromObservable;
  ...
  Event5.fromObservableLight = fromObservableLight;
})(Event || (Event = {}));
...
var ConfigurationRegistry = class extends Disposable {
  ...
  updateDefaultOverrideProperty(key, newDefaultOverride, source) {
    const property = {
      ...
      description: localize(1894, null, getLanguageTagSettingPlainKey(key)),
  ...
  updateOverridePropertyPatternKey() {
    for (const overrideIdentifier of this.overrideIdentifiers.values()) {
      ...
      const resourceLanguagePropertiesSchema = {
        type: "object",
        description: localize(1896, null),
        errorMessage: localize(1897, null),
        $ref: resourceLanguageSettingsSchemaId
      };
...
function validateProperty(property, schema, extensionId) {
  if (!property.trim()) {
    return localize(1892, null);
  }
  if (OVERRIDE_PROPERTY_REGEX.test(property)) {
    return localize(1893, null, property);
  }
  if (configurationRegistry.getConfigurationProperties()[property] !== void 0 && (!extensionId || !EXTENSION_UNIFICATION_EXTENSION_IDS.has(extensionId.toLowerCase()))) {
    return localize(1891, null, property);
  }
  if (schema.policy?.name && configurationRegistry.getPolicyConfigurations().get(schema.policy?.name) !== void 0) {
    return localize(1890, null, property, schema.policy?.name, configurationRegistry.getPolicyConfigurations().get(schema.policy?.name));
  }
  return null;
}
...
var NO_FETCH_TELEMETRY = "NO_FETCH_TELEMETRY";
  ...
  proxyConfiguration = [
    {
      ...
      properties: {
        "http.useLocalProxyConfiguration": {
          ...
          markdownDescription: localize(2337, null),
          restricted: true
        }
      }
    },
    {
      ...
      properties: {
        "http.electronFetch": {
          type: "boolean",
          default: false,
          description: localize(2320, null),
          restricted: true
        }
      }
    },
    {
      ...
      title: localize(2322, null),
      type: "object",
      scope: useHostProxy ? 1 /* APPLICATION */ : 2 /* MACHINE */,
      properties: {
        "http.proxy": {
          type: "string",
          pattern: "^(https?|socks|socks4a?|socks5h?)://([^:]*(:[^@]*)?@)?([^:]+|\\[[:0-9a-fA-F]+\\])(:\\d+)?/?$|^$",
          markdownDescription: localize(2325, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.proxyStrictSSL": {
          type: "boolean",
          default: true,
          markdownDescription: localize(2333, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.proxyKerberosServicePrincipal": {
          type: "string",
          markdownDescription: localize(2327, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.noProxy": {
          type: "array",
          items: { type: "string" },
          markdownDescription: localize(2324, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.proxyAuthorization": {
          type: ["null", "string"],
          default: null,
          markdownDescription: localize(2326, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.proxySupport": {
          type: "string",
          ...
          default: "override",
          markdownDescription: localize(2328, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.systemCertificates": {
          type: "boolean",
          default: true,
          markdownDescription: localize(2334, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.systemCertificatesNode": {
          ...
          markdownDescription: localize(2335, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true,
          experiment: {
            mode: "auto"
          }
        ...
        "http.experimental.systemCertificatesV2": {
          ...
          tags: ["experimental"],
          default: false,
          markdownDescription: localize(2336, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true
        },
        "http.fetchAdditionalSupport": {
          type: "boolean",
          default: true,
          markdownDescription: localize(2321, null, "`#http.useLocalProxyConfiguration#`", "`#http.proxySupport#`", "`#http.systemCertificates#`"),
          restricted: true
        },
        "http.webSocketAdditionalSupport": {
          type: "boolean",
          default: true,
          markdownDescription: localize(2338, null, "`#http.useLocalProxyConfiguration#`", "`#http.proxySupport#`", "`#http.systemCertificates#`"),
          restricted: true
        },
        "http.experimental.networkInterfaceCheckInterval": {
          ...
          minimum: -1,
          tags: ["experimental"],
          markdownDescription: localize(2323, null, "`#http.useLocalProxyConfiguration#`"),
          restricted: true,
          experiment: {
            mode: "auto"
          }
...
var TelemetryLogGroup = { id: telemetryLogId, name: localize(2362, null) };

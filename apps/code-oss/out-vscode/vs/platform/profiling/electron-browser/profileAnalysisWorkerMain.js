...
var PerformanceError = class extends Error {
  constructor(data) {
...
var IProfileAnalysisWorkerService = createDecorator("IProfileAnalysisWorkerService");
var ProfileAnalysisWorkerService = class {
...
registerSingleton(IProfileAnalysisWorkerService, ProfileAnalysisWorkerService, 1 /* Delayed */);
...
var ProfileAnalysisWorker = class {
  ...
  $analyseBottomUp(profile) {
    if (!Utils.isValidProfile(profile)) {
      return { kind: 1 /* Irrelevant */, samples: [] };
    }
    ...
    return { kind: 2 /* Interesting */, samples };
  }

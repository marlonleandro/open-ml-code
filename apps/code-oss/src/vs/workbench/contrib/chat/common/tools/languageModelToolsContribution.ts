		...
		languageModelToolsExtensionPoint.setHandler((_extensions, delta) => {
			for (const extension of delta.added) {
				for (const rawTool of extension.value) {
					...
					const defaultChatExtensionId = productService.defaultChatAgent?.chatExtensionId;
					const isBuiltinTool = defaultChatExtensionId ?
						ExtensionIdentifier.equals(extension.description.identifier, defaultChatExtensionId) :
